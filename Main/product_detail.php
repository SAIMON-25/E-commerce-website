        ...
        <nav class="navbar navbar-expand-lg hover-effect">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="icons">
                    <p style="display: inline-block; margin-right: 10px; font-size: 18px;font-weight: bold;">Total Price : <?php $price = get_total_price(); echo "$price"; ?> BDT</p>
                        <a href="#" class="text-dark">
                            <i class="fa-solid fa-cart-shopping"><sup style="color: white; font-size: 12px; margin-left: 5px;"><?php $cnt = get_cart_item_number(); echo "$cnt"?></sup></i>
                        </a>
                        <a href="#" class="text-dark">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row ">
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            $price = $row['price'];
                            echo "
                         <div class='container d-flex' style='box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);margin-left:15px;margin-right:15px;'>
                         <img src='../Admin/product_images/$image' alt='$image' style='width:400px;height: 450px;'>
                          <div class='detail mt-5 ms-4'>
                         <h2>$name</h2>
                       <h3>Description:</h3>
                    <p>$description</p>
                   <div>
